...
export class GlPlayerObject  {
    ...
    public init(pivot: Pivot3d) {
        ...
        const material_x: THREE.LineBasicMaterial = new THREE.LineBasicMaterial({color:System3d.AXIS_X_COLOR});
        ...
        const material_y: THREE.LineBasicMaterial = new THREE.LineBasicMaterial({color:System3d.AXIS_Y_COLOR});
        ...
        const material_z: THREE.LineBasicMaterial = new THREE.LineBasicMaterial({color:System3d.AXIS_Z_COLOR});
