...
import { TexturePainter } from "@/app/terrains/gentexture/texturepainter";
...
export function TextureViewer({ terrainConfig, terrainMesh, 
   ...
   const [ready, setReady] = useState<boolean>(false);
    ...
    const texturePainter = useRef<TexturePainter|null>(null);
    ...
    useEffect(() => {
        ...
        texturePainter.current = new TexturePainter
