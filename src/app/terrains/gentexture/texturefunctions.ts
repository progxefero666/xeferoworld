...
*/
export const drawSingleRiver = (texturePainter: TexturePainter) => {
    const startPoint: Vector2d = { x: 50, y: 50 };
    const endPoint: Vector2d = { x: 350, y: 350 };
    const rayPoints: Vector2d[] = RiversGenerator.generateRiverPoints(startPoint, endPoint, 7, 50, 0.7);
...
River System
    ...
    baseSubdiv: number = 8    
*/
export const drawComplexRiver = (texturePainter: TexturePainter) => {
    ...
    const riverPoints: Vector2d[][] = RiversGenerator.generateComplexRiverA(
...
export const drawPlaneZones = (texturePainter: TexturePainter) => {
