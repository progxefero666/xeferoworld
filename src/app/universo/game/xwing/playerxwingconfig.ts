...
export class PlayerXwingCfg {
    ...
    public static ATT_DIST_TO_CONVERG:number 
        = PlayerXwingCfg.ATT_TIME_TO_CONVERG * PlayerXwingCfg.ATT_BULL_A_PHYVEL; 

    public static BULLETS_A_TICKVEL:number 
        = FlySystemUtil.msToTick(PlayerXwingCfg.ATT_BULL_A_PHYVEL);
    ...
    public static getGlCannons():Mesh[] {
        ...
        gunRefObj_RU.position.set(PlayerXwingCfg.CANNON_RU_COORDS.x,
                                  PlayerXwingCfg.CANNON_RU_COORDS.y,
                                  PlayerXwingCfg.CANNON_RU_COORDS.z);
       gunRefObj_LU.position.set(PlayerXwingCfg.CANNON_LU_COORDS.x,
                                  PlayerXwingCfg.CANNON_LU_COORDS.y,
                                  PlayerXwingCfg.CANNON_LU_COORDS.z);

        gunRefObj_RD.position.set(PlayerXwingCfg.CANNON_RD_COORDS.x,
                                  PlayerXwingCfg.CANNON_RD_COORDS.y,
                                  PlayerXwingCfg.CANNON_RD_COORDS.z); 
        gunRefObj_LD.position.set(PlayerXwingCfg.CANNON_LD_COORDS.x,
                                  PlayerXwingCfg.CANNON_LD_COORDS.y,
                                  PlayerXwingCfg.CANNON_LD_COORDS.z); 
    ...
    public static getGlTarget():Mesh {
        return new Mesh(
            new SphereGeometry(PlayerXwingCfg.CRH_GLOBJ_RADIUS,16,16),
            new MeshBasicMaterial({color:PlayerXwingCfg.CRH_GLOBJ_COLOR}));
    }//end
...
export class PlayerShipCfg {
    ...
    public static CRH_POSITION:number[] = [
        ...
        PlayerXwingCfg.ATT_DIST_TO_CONVERG*(-1)];    
