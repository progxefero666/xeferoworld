...
import { Terrains3dTests } from "@/app/terrains/test/terraintest";
...
export default function PageTerrains3d() {
    ...
    const [sectionId,setSectionId] = useState<string>(Terrains3dConfig.SECTIONS[1].id);
