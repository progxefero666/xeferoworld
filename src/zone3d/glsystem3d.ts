...
export class GlSystem3d {
    ...
    public static readonly AXIS_X_COLOR: string = "#FF0000"; // Red
    public static readonly AXIS_Y_COLOR: string = "#00FF00"; // Green
    public static readonly AXIS_Z_COLOR: string = "#0000FF"; // Blue
